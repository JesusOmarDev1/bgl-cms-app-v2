  ...
  return (
    <PopoverTrigger>
      <button
        ...
        className={cn(
          "inline-flex h-9 w-full items-center justify-between gap-2 rounded-sm border border-input bg-transparent px-3 text-start font-mono text-sm uppercase tabular-nums transition-colors outline-none",
  ...
  return (
    ...
    >
      <span
        ...
        className="pointer-events-none absolute size-3 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-white shadow-[0_0_0_1px_rgba(0,0,0,0.5)] rtl:translate-x-1/2"
        style={{
          left: `${ctx.hsv.s}%`,
          top: `${100 - ctx.hsv.v}%`,
        }}
  ...
  return (
    ...
    >
      <span
        ...
        className="pointer-events-none absolute top-1/2 size-3 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-white shadow-[0_0_0_1px_rgba(0,0,0,0.5)] rtl:translate-x-1/2"
...
function ColorPickerFormatTabs({
  ...
  return (
    <Tabs
      ...
      defaultSelectedKey={ctx.format.toString()}
      onSelectionChange={(v: any) => ctx.setFormat(v as ColorFormat)}
      className={className}
    >
