...
export function LogosCarousel({
  ...
  const nextIndex = groupsLength === 0 ? 0 : (index + 1) % groupsLength
  ...
  React.useEffect(() => {
    ...
    function loop() {
      setIndex((prevIndex) => (prevIndex + 1) % groupsLength)
    }
  ...
  return (
    <>
      ...
      `}</style>
      <div className="grid w-full max-w-[720px] place-items-center">
